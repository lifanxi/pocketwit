...
{
    public class TwitPicApiBase : PictureServiceBase
    {
        ...
        protected string API_UPLOAD = "http://api.twitpic.com/2/upload.xml";
        protected string API_UPLOAD_POST = "http://api.twitpic.com/2/upload.xml";
        protected string API_SHOW_THUMB = "http://twitpic.com/show/large/";  //The extra / for directly sticking the image-id on.

        protected string API_ERROR_UPLOAD = "Unable to upload to TwitPic";
        protected string API_ERROR_DOWNLOAD = "Unable to download from TwitPic";
