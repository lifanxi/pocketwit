...
namespace PockeTwit.MediaServices
{
    class FanfouPhoto : PictureServiceBase
    {
        ...
        private const string API_ERROR_DOWNLOAD = "Unable to download picture.";
        private const string API_ERROR_UPLOAD = "Unable to upload picture.";
        ...
        public override bool PostPicture(PicturePostObject postData, Yedda.Twitter.Account account)
        {
            postData.URL = "http://fanfou.com/photo/fanfou";
            return true;
        }

        public override void FetchPicture(string pictureURL, Yedda.Twitter.Account account)
        {
        ...
        public bool PostPictureMessage(PicturePostObject postData)
        {
            #region Argument check
